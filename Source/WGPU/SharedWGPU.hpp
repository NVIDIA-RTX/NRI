...
WGPUTextureFormat nri::GetTextureFormat(Format format) {
    switch (format) {
        ...
        case Format::RG32_SFLOAT: return WGPUTextureFormat_RG32Float;
        case Format::RGBA32_UINT: return WGPUTextureFormat_RGBA32Uint;
        case Format::RGBA32_SINT: return WGPUTextureFormat_RGBA32Sint;
        case Format::RGBA32_SFLOAT: return WGPUTextureFormat_RGBA32Float;
        case Format::R10_G10_B10_A2_UINT: return WGPUTextureFormat_RGB10A2Uint;
        case Format::R10_G10_B10_A2_UNORM: return WGPUTextureFormat_RGB10A2Unorm;
        case Format::R11_G11_B10_UFLOAT: return WGPUTextureFormat_RG11B10Ufloat;
        case Format::R9_G9_B9_E5_UFLOAT: return WGPUTextureFormat_RGB9E5Ufloat;
        ...
        case Format::BC2_RGBA_UNORM: return WGPUTextureFormat_BC2RGBAUnorm;
        case Format::BC2_RGBA_SRGB: return WGPUTextureFormat_BC2RGBAUnormSrgb;
        ...
        case Format::BC4_R_SNORM: return WGPUTextureFormat_BC4RSnorm;
        case Format::BC5_RG_UNORM: return WGPUTextureFormat_BC5RGUnorm;
        case Format::BC5_RG_SNORM: return WGPUTextureFormat_BC5RGSnorm;
        case Format::BC6H_RGB_UFLOAT: return WGPUTextureFormat_BC6HRGBUfloat;
        case Format::BC6H_RGB_SFLOAT: return WGPUTextureFormat_BC6HRGBFloat;
        ...
        case Format::ETC2_RGB8_UNORM: return WGPUTextureFormat_ETC2RGB8Unorm;
        case Format::ETC2_RGB8_SRGB: return WGPUTextureFormat_ETC2RGB8UnormSrgb;
        case Format::ETC2_RGB8_A1_UNORM: return WGPUTextureFormat_ETC2RGB8A1Unorm;
        case Format::ETC2_RGB8_A1_SRGB: return WGPUTextureFormat_ETC2RGB8A1UnormSrgb;
        case Format::ETC2_RGB8_A8_UNORM: return WGPUTextureFormat_ETC2RGBA8Unorm;
        case Format::ETC2_RGB8_A8_SRGB: return WGPUTextureFormat_ETC2RGBA8UnormSrgb;
        case Format::ETC2_R11_UNORM: return WGPUTextureFormat_EACR11Unorm;
        case Format::ETC2_R11_SNORM: return WGPUTextureFormat_EACR11Snorm;
        case Format::ETC2_R11_G11_UNORM: return WGPUTextureFormat_EACRG11Unorm;
        case Format::ETC2_R11_G11_SNORM: return WGPUTextureFormat_EACRG11Snorm;
        case Format::ASTC_4X4_UNORM: return WGPUTextureFormat_ASTC4x4Unorm;
        case Format::ASTC_4X4_SRGB: return WGPUTextureFormat_ASTC4x4UnormSrgb;
        case Format::ASTC_5X4_UNORM: return WGPUTextureFormat_ASTC5x4Unorm;
        case Format::ASTC_5X4_SRGB: return WGPUTextureFormat_ASTC5x4UnormSrgb;
        case Format::ASTC_5X5_UNORM: return WGPUTextureFormat_ASTC5x5Unorm;
        case Format::ASTC_5X5_SRGB: return WGPUTextureFormat_ASTC5x5UnormSrgb;
        case Format::ASTC_6X5_UNORM: return WGPUTextureFormat_ASTC6x5Unorm;
        case Format::ASTC_6X5_SRGB: return WGPUTextureFormat_ASTC6x5UnormSrgb;
        case Format::ASTC_6X6_UNORM: return WGPUTextureFormat_ASTC6x6Unorm;
        case Format::ASTC_6X6_SRGB: return WGPUTextureFormat_ASTC6x6UnormSrgb;
        case Format::ASTC_8X5_UNORM: return WGPUTextureFormat_ASTC8x5Unorm;
        case Format::ASTC_8X5_SRGB: return WGPUTextureFormat_ASTC8x5UnormSrgb;
        case Format::ASTC_8X6_UNORM: return WGPUTextureFormat_ASTC8x6Unorm;
        case Format::ASTC_8X6_SRGB: return WGPUTextureFormat_ASTC8x6UnormSrgb;
        case Format::ASTC_8X8_UNORM: return WGPUTextureFormat_ASTC8x8Unorm;
        case Format::ASTC_8X8_SRGB: return WGPUTextureFormat_ASTC8x8UnormSrgb;
        case Format::ASTC_10X5_UNORM: return WGPUTextureFormat_ASTC10x5Unorm;
        case Format::ASTC_10X5_SRGB: return WGPUTextureFormat_ASTC10x5UnormSrgb;
        case Format::ASTC_10X6_UNORM: return WGPUTextureFormat_ASTC10x6Unorm;
        case Format::ASTC_10X6_SRGB: return WGPUTextureFormat_ASTC10x6UnormSrgb;
        case Format::ASTC_10X8_UNORM: return WGPUTextureFormat_ASTC10x8Unorm;
        case Format::ASTC_10X8_SRGB: return WGPUTextureFormat_ASTC10x8UnormSrgb;
        case Format::ASTC_10X10_UNORM: return WGPUTextureFormat_ASTC10x10Unorm;
        case Format::ASTC_10X10_SRGB: return WGPUTextureFormat_ASTC10x10UnormSrgb;
        case Format::ASTC_12X10_UNORM: return WGPUTextureFormat_ASTC12x10Unorm;
        case Format::ASTC_12X10_SRGB: return WGPUTextureFormat_ASTC12x10UnormSrgb;
        case Format::ASTC_12X12_UNORM: return WGPUTextureFormat_ASTC12x12Unorm;
        case Format::ASTC_12X12_SRGB: return WGPUTextureFormat_ASTC12x12UnormSrgb;
        ...
        case Format::D32_SFLOAT_S8_UINT: return WGPUTextureFormat_Depth32FloatStencil8;
...
WGPUTextureFormat nri::GetSwapChainTextureFormat(SwapChainFormat format) {
    switch (format) {
        case SwapChainFormat::BT709_G22_8BIT: return WGPUTextureFormat_RGBA8Unorm;
        case SwapChainFormat::BT709_G10_16BIT: return WGPUTextureFormat_RGBA16Float;
...
Format nri::GetNRIFormat(WGPUTextureFormat format) {
    switch (format) {
        ...
        case WGPUTextureFormat_RGBA16Float: return Format::RGBA16_SFLOAT;
...
WGPUTextureViewDimension nri::GetTextureViewDimension(TextureView type, const TextureDesc& textureDesc) {
    switch (type) {
        ...
        case TextureView::TEXTURE_CUBE: return WGPUTextureViewDimension_Cube;
        case TextureView::TEXTURE_CUBE_ARRAY: return WGPUTextureViewDimension_CubeArray;
        default:
...
WGPUAddressMode nri::GetAddressMode(AddressMode mode) {
    switch (mode) {
        ...
        case AddressMode::MIRRORED_REPEAT: return WGPUAddressMode_MirrorRepeat;
...
WGPUStencilOperation nri::GetStencilOperation(StencilOp stencilOp) {
    switch (stencilOp) {
        ...
        case StencilOp::INCREMENT_AND_CLAMP: return WGPUStencilOperation_IncrementClamp;
        case StencilOp::DECREMENT_AND_CLAMP: return WGPUStencilOperation_DecrementClamp;
        case StencilOp::INVERT: return WGPUStencilOperation_Invert;
        case StencilOp::INCREMENT_AND_WRAP: return WGPUStencilOperation_IncrementWrap;
        case StencilOp::DECREMENT_AND_WRAP: return WGPUStencilOperation_DecrementWrap;
...
WGPUPrimitiveTopology nri::GetPrimitiveTopology(Topology topology) {
    switch (topology) {
        case Topology::POINT_LIST: return WGPUPrimitiveTopology_PointList;
        case Topology::LINE_LIST: return WGPUPrimitiveTopology_LineList;
        case Topology::LINE_STRIP: return WGPUPrimitiveTopology_LineStrip;
        case Topology::TRIANGLE_STRIP: return WGPUPrimitiveTopology_TriangleStrip;
...
WGPUBlendFactor nri::GetBlendFactor(BlendFactor blendFactor) {
    switch (blendFactor) {
        ...
        case BlendFactor::SRC_COLOR: return WGPUBlendFactor_Src;
        case BlendFactor::ONE_MINUS_SRC_COLOR: return WGPUBlendFactor_OneMinusSrc;
        case BlendFactor::DST_COLOR: return WGPUBlendFactor_Dst;
        case BlendFactor::ONE_MINUS_DST_COLOR: return WGPUBlendFactor_OneMinusDst;
        case BlendFactor::SRC_ALPHA: return WGPUBlendFactor_SrcAlpha;
        case BlendFactor::ONE_MINUS_SRC_ALPHA: return WGPUBlendFactor_OneMinusSrcAlpha;
        case BlendFactor::DST_ALPHA: return WGPUBlendFactor_DstAlpha;
        case BlendFactor::ONE_MINUS_DST_ALPHA: return WGPUBlendFactor_OneMinusDstAlpha;
        case BlendFactor::CONSTANT_COLOR:
        case BlendFactor::CONSTANT_ALPHA: return WGPUBlendFactor_Constant;
        case BlendFactor::ONE_MINUS_CONSTANT_COLOR:
        case BlendFactor::ONE_MINUS_CONSTANT_ALPHA: return WGPUBlendFactor_OneMinusConstant;
        case BlendFactor::SRC_ALPHA_SATURATE: return WGPUBlendFactor_SrcAlphaSaturated;
        case BlendFactor::SRC1_COLOR: return WGPUBlendFactor_Src1;
        case BlendFactor::ONE_MINUS_SRC1_COLOR: return WGPUBlendFactor_OneMinusSrc1;
        case BlendFactor::SRC1_ALPHA: return WGPUBlendFactor_Src1Alpha;
        case BlendFactor::ONE_MINUS_SRC1_ALPHA: return WGPUBlendFactor_OneMinusSrc1Alpha;
...
WGPUBlendOperation nri::GetBlendOperation(BlendOp blendOp) {
    switch (blendOp) {
        ...
        case BlendOp::REVERSE_SUBTRACT: return WGPUBlendOperation_ReverseSubtract;

...
del /q "%DIR_DATA%\*.dll"
copy "_Build\TargetDeps\Assimp\Bin\*.dll" "%DIR_DATA%\"
copy "_Build\TargetDeps\AGS\lib\*.dll" "%DIR_DATA%\"
copy "External\NGX\*.dll" "%DIR_DATA%\"
copy "Tests\Bistro*.bin" "%DIR_DATA%\Scenes\Bistro\"
